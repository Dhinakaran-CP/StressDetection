...
if __name__ == "__main__":
    import yaml
    with open("configs/feature_contract.yaml", "r") as f:
    ...
    face_df, face_oof = run_modality_experiments("Face", "certified_data/face_certified.csv", face_cols, face_base)
    voice_df, voice_oof = run_modality_experiments("Voice", "certified_data/voice_certified.csv", voice_cols, voice_base)
    physio_df, physio_oof = run_modality_experiments("Physio", "certified_data/physio_certified.csv", physio_cols, physio_base)
